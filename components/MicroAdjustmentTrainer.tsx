...
export default function MicroAdjustmentTrainer() {
  ...
  useEffect(() => {
    ...
    const rec = createRecording('micro-adjustment');
  ...
  return (
    <GameShell ref={shellRef} flashOpacity={flashOpacity}>
      <Overlay
        ...
        onSaveReplay={() => recordingRef.current && saveReplay({ recording: recordingRef.current, mode: 'micro-adjustment', difficulty, score: state.score })}
